...
const ResultSearchInvoice = () => {
    
    const { invoicesSearch, searching } = useSelector(state => state.invoices);
    const { id } = useSelector(state => state.user);
    const invoces = invoicesSearch.reverse()
...
export default ResultSearchInvoice;